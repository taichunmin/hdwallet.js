...
import {
  ELECTRUM_V1_MNEMONIC_LANGUAGES, ELECTRUM_V1_MNEMONIC_WORDS, ElectrumV1Mnemonic
} from '../../../../src/mnemonics';
...
).fromMnemonic(new ElectrumV1Mnemonic(
  ElectrumV1Mnemonic.fromWords(
    ELECTRUM_V1_MNEMONIC_WORDS.TWELVE, ELECTRUM_V1_MNEMONIC_LANGUAGES.ENGLISH
  )
