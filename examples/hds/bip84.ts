...
import { BIP84HD } from '../../src/hds/bip84';
...
bip84HD.fromXPrivateKey(xPrivateKey, true);
// bip84HD.fromXPublicKey(xPublicKey, true);
...
// bip84HD.fromCoinType(Bitcoin.COIN_TYPE);
// bip84HD.fromAccount(10);
// bip84HD.fromChange(CHANGES.INTERNAL_CHANGE);
// bip84HD.fromAddress(5);
