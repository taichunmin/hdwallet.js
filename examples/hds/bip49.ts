...
import { BIP49HD } from '../../src/hds/bip49';
...
bip49HD.fromXPrivateKey(xPrivateKey, true);
// bip49HD.fromXPublicKey(xPublicKey, true);
...
// bip49HD.fromCoinType(Bitcoin.COIN_TYPE);
// bip49HD.fromAccount(10);
// bip49HD.fromChange(CHANGES.INTERNAL_CHANGE);
// bip49HD.fromAddress(5);
