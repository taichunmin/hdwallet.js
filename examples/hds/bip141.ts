...
bip141HD.fromXPrivateKey(xPrivateKey, true);
// bip141HD.fromXPublicKey(xPublicKey, true);
...
// bip141HD.fromCoinType(Bitcoin.COIN_TYPE);
// bip141HD.fromAccount(10);
// bip141HD.fromChange(CHANGES.INTERNAL_CHANGE);
// bip141HD.fromAddress(5);
