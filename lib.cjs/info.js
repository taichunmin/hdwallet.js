...
exports.__version__ = '1.0.0-beta.3';
...
exports.__changelog__ = `${exports.__source__}/blob/master/CHANGELOG.md`;
exports.__tracker__ = `${exports.__source__}/issues`;
exports.__keywords__ = [
